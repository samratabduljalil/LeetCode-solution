class Solution:
    def addStrings(self, num1: str, num2: str) -> str:
        ...
        for i in range(len(Min_length_num)):
            digit1 = ord(Min_length_num[len(Min_length_num)-1-i])-ord('0')
            digit2 = ord(Max_length_num[len(Max_length_num)-1-i])-ord('0')
            ...
            if result <10:
                ...
                On_Hand=1
        for i in range(len(Min_length_num),len(Max_length_num)):
            digit1 = ord(Max_length_num[len(Max_length_num)-1-i])-ord('0')
            if On_Hand==1:
